...
export async function fetchAllDownloadsFromService(): Promise<
...
export async function fetchTotalDownloadCountFromService(): Promise<
  ApiResponse<number>
> {
...
export async function fetchDownloadsInLast24HoursFromService(): Promise<
  ApiResponse<Download[]>
> {
  const now = new Date();
