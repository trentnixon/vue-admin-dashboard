...
export const accountCustomers = computed(() => usePrivateCustomerState().accountCustomers);
export const customerDetails = computed(() => usePrivateCustomerState().customerDetails);
...
export const accountCustomerCount = computed(() => accountCustomers.value.length);
